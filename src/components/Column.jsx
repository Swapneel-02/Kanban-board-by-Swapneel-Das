...
import { getPriorityIcon, getStatusIcon } from './../constants/imageConstants';
    ...
    return (
        <div className='column'>
            ...
            <div className='cards-container'>
                {tickets.map((ticket) => <Card key={ticket.id} ticket={ticket} userData={userIdToData[ticket.userId]} hideStatusIcon={grouping === "status"} hideProfileIcon={grouping === "user"} hidePriorityIcon={grouping === "priority"}/>)}
            </div>
        </div>
    );
}
